...
def test_all_expected_routes_registered():
    ...
    expected = {
        ...
        '/api/v1/users/me/skills/{skill_id}': {'PATCH', 'DELETE'},
        '/api/v1/departments/': {'GET', 'POST'},
        '/api/v1/departments/{dept_id}': {'GET', 'PATCH', 'DELETE'},
        ...
        '/api/v1/user-skills/{us_id}': {'GET', 'PATCH', 'DELETE'},
        '/api/v1/topic-skills/': {'GET', 'POST'},
        '/api/v1/topic-skills/{topic_id}/{skill_id}': {'GET', 'PATCH', 'DELETE'},
